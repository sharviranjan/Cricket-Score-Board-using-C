...
struct Player *createPlayer(char playerName[])
{
...
void insertPlayer(struct Player **head, char playerName[])
{
...
void displayScoreBoard(struct ScoreBoard *board)
{
    ...
    struct Player *current = board->head;
    printf("\nPlayers\t\tRuns\n");
    while (current != NULL)
    {
        printf("%s\t\t%d\n", current->name, current->runs);
        current = current->next;
    }
    printf("---------------------------------------------------\n");
}

void updateScore(struct ScoreBoard *board, char playerName[], int runs)
{
    struct Player *current = board->head;
    while (current != NULL)
    {
...
int main2()
{
    ...
    do
    {
        ...
        case 1:
            ...
            scanf("%s", playerName);
            insertPlayer(&board.head, playerName);
            break;
        case 2:
            printf("Enter player name: ");
            scanf("%s", playerName);
            ...
            scanf("%d", &runs);
            updateScore(&board, playerName, runs);
            break;
        case 3:
